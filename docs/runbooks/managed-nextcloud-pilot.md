...
| Talk push notifications (Android) | ✅ **work (2026-09-22)** — test push and real messages both arrive. The initial "no notifications" was **active-session suppression**: Talk generates no push for a conversation you have open, **including a background browser tab**. ⚠️ **Onboarding note (DOC-5):** members who keep Talk open on a laptop will get a silent phone and assume it's broken. See [talk-notifications.md](talk-notifications.md). |
