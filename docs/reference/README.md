...
| [access-register.md](access-register.md) | Who has access to what, and when it was granted or removed — **structure only; the populated register is kept off this public repo** |
